...
(let* ((base-font-color  (face-foreground 'default nil 'default))
  ...
  (custom-theme-set-faces
   'user
   `(org-document-title   ((t (,@headline :height 2.50 :underline t))))
   `(org-level-1          ((t (,@headline :height 2.25 :foreground "#e6194b"))))
   `(org-level-2          ((t (,@headline :height 2.00 :foreground "#3cb44b"))))
   `(org-level-3          ((t (,@headline :height 1.75 :foreground "#ffe119"))))
   `(org-level-4          ((t (,@headline :height 1.70 :foreground "#4363d8"))))
   `(org-level-5          ((t (,@headline :height 1.35 :foreground "#f58231"))))
...
(general-define-key
 ...
 "C-M-!" 'eyebrowse-switch-to-window-config-1
 "C-M-\"" 'eyebrowse-switch-to-window-config-2
 "C-M-£" 'eyebrowse-switch-to-window-config-3
 "C-M-$" 'eyebrowse-switch-to-window-config-4
 "C-M-%" 'eyebrowse-switch-to-window-config-5
 "C-M-^" 'eyebrowse-switch-to-window-config-6
 "C-M-&" 'eyebrowse-switch-to-window-config-7
 "C-M-*" 'eyebrowse-switch-to-window-config-8
 "C-M-(" 'eyebrowse-switch-to-window-config-9
 "C-M-<" 'previous-buffer
 "C-M->" 'next-buffer
 )
#+END_SRC
...
(edits-leader
 ...
 "ah" 'ignore ; unbind 'normal' keybinds these so they don't show up in org mode
 "aH" 'ignore
 "at" 'ignore
 "aT" 'ignore
...
(general-define-key
 ...
 "C-M-p" 'eyebrowse-prev-window-config
