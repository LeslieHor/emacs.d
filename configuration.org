...
(defun circ/pass/generate-entry (&optional entry)
  ...
  (when (file-exists-p (circ/pass/get-entry-path entry))
    (unless (y-or-n-p (format "%s already exists. Overwrite? " entry))
...
(evil-define-key 'motion elfeed-search-mode-map
  ...
  "M" 'circ/elfeed-search-untag-saved
...
(evil-define-key 'motion elfeed-show-mode-map
  ...
  "M" 'circ/elfeed-show-untag-saved)
#+END_SRC
** emux
#+BEGIN_SRC emacs-lisp
...
(circ/p1 "v a"  'vc-annotate                          "annotate")
...
(circ/p2 "p g"  'circ/pass/generate                   "generate")
#+END_SRC
