...
** vc shortcuts
#+BEGIN_SRC emacs-lisp
(defun circ/vc-diff-master-current ()
...
(defun circ/evil-set-notmuch-keys ()
  ...
  (evil-define-key '(motion visual) notmuch-search-mode-map
    ...
    "d" 'circ/notmuch-search-mark-delete
    "u" 'circ/notmuch-search-mark-read
    "U" 'circ/notmuch-search-mark-unread
  ...
  (evil-define-key 'motion notmuch-show-mode-map
    ...
    "d" 'circ/notmuch-show-mark-delete
    "u" 'circ/notmuch-show-mark-read
    "U" 'circ/notmuch-show-mark-unread
...
(circ/p1 "v dm" 'circ/vc-diff-master-current          "compare current to master")
