...
(leslie/p1 "n"    'neotree-create-node                  "create directory / file"             'neotree-mode-map)
(leslie/p1 "d"    'neotree-delete-node                  "delete directory / file"             'neotree-mode-map)
(leslie/p1 "r"    'neotree-rename-node                  "rename directory / file"             'neotree-mode-map)
(leslie/p1 "t"    'neotree-change-root                  "change root directory"               'neotree-mode-map)
(leslie/p1 "c"    'neotree-copy-node                    "copy directory / file"               'neotree-mode-map)
...
(leslie/p1 "w z"  'neotree-stretch-toggle               "maximize tree pane"                  'neotree-mode-map)
...
(leslie/p1 "t n"  'neotree-toggle                       "toggle neotree")
(leslie/p1 "t p"  'projectile-mode                      "toggle projectile mode")
(leslie/p1 "t f"  'font-lock-mode                       "toggle auto font formatting")
(leslie/p1 "t c"  'comment-line                         "comment line")
(leslie/p1 "t r"  'rainbow-delimiters-mode              "rainbow delimiters")
(leslie/p1 "t l"  'nlinum-mode                          "toggle relative line numbers")
(leslie/p1 "t i"  'org-toggle-inline-images             "toggle images"                       'org-mode-map)
(leslie/p1 "t t"  'nil                                  "todo / tables"                       'org-mode-map)
(leslie/p1 "t ts" 'org-todo                             "cycle todo"                          'org-mode-map)
(leslie/p1 "t tr" 'org-table-toggle-coordinate-overlay  "toggle images"                       'org-mode-map)
(leslie/p1 "t h"  'ranger-toggle-dotfiles               "toggle hidden"                       'ranger-mode-map)
(leslie/p1 "t c"  'neotree-collapse-all                 "collapse all"                        'neotree-mode-map)
(leslie/p1 "t h"  'neotree-hdden-file-toggle            "toggle hidden"                       'neotree-mode-map)
(leslie/p1 "e"    'nil                                  "edits")
(leslie/p1 "e f"  'nil                                  "fill")
...
(leslie/p3 "f b"  'ivy-eyebrowse-switch-config          "switch config")
...
(leslie/p4 "a"    'org-agenda                           "agenda"                              'org-mode-map)
