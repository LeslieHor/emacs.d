...
(let* ((base-font-color  (face-foreground 'default nil 'default))
  ...
  (custom-theme-set-faces
   'user
   `(org-level-8        ((t (,@headline :height 1.20))))
   `(org-level-7        ((t (,@headline :height 1.20))))
   `(org-level-6        ((t (,@headline :height 1.30))))
   `(org-level-5        ((t (,@headline :height 1.25))))
   `(org-level-4        ((t (,@headline :height 1.50))))
   `(org-level-3        ((t (,@headline :height 1.65))))
   `(org-level-2        ((t (,@headline :height 2.00))))
   `(org-level-1        ((t (,@headline :height 2.25))))
