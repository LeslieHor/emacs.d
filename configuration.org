...
(circ/p1 ","    'circ/tab-line-switch-to-prev-tab     "prev tab")
(circ/p1 "."    'circ/tab-line-switch-to-next-tab     "next tab")
...
(circ/p1 "c"    'circ/tab-line-close-tab              "close tab")
...
(circ/p1 "w c"  'delete-windows                       "close window")
